  ...
  return (function () {
  ...
  })()(
    {
      1: [
        ...
        {
          "./services/external.order.form": 2,
          "./services/hello.world": 3,
          "./services/random.generator": 4,
        },
      ],
      2: [
        function (require, module, exports) {
          ...
          function getCompanyInfoAjaxConfig(identificationNo) {
            var url =
              "/getCompanyInfobyIdentificationNumber/" + identificationNo;
            return {
              url: url,
              type: "GET",
              dataType: "json",
        ...
        function (require, module, exports) {
          ...
          function getAlphaNumericValue(length) {
            ...
            for (var i = 0; i < length; i++) {
              chars.push(
                ALPHA_NUMERIC_SEED[
                  Math.floor(Math.random() * ALPHA_NUMERIC_SEED.length)
                ]
              );
            }
